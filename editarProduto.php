                  ...
                  <div class="tab-pane active" id="settings"> 
                    <form class="form-horizontal" method="POST">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="number" name="newPrice" class="form-control" value="<?php echo $preço?>">
                        </div>
                      </div>
                      <div class="form-group row">
...
<?php
  ...
  $ct=mysqli_fetch_assoc($query);
      ...
      if (isset($_POST['edit'])) {
          ...
          $b= "update produto set nomeProduto = '$novoProduto', preçoProduto='$novoPreço', fk_idGenero='$novoGenero', quantidade='$novaQuantidade' where idProduto='$id'";
          mysqli_query($con, $b);
